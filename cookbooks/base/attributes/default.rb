...
applications[:basecamp] = {:completed => true, :thumbnails => true, :logsort => true, :haproxy => true, :gems => ['fast_xs', 'hpricot', 'aws-s3', 'ruby-prof', ['net-ssh', '1.1.4'], ['net-sftp', '1.1.1']],
...
applications[:forum] = {:gems => [['ruby-openid', '1.1.4'], 'memcache-client']}
