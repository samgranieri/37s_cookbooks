...
roles[:proxy]         = {:groups => [:admin, :app], :sudo_groups => [:admin, :app]}
roles[:cf_poll]       = {:groups => [:admin, :app], :sudo_groups => [:admin, :app]}
...
ssh_keys[:jz]      = "ssh-rsa  jzimdars@jason-zimdarss-macbook-pro.local"
