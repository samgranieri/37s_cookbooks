apt-get update
apt-get -y install emacs22-nox vim git-core mysql-client libmysqlclient15-dev build-essential syslog-ng ntp ruby ruby1.8-dev rubygems libopenssl-ruby1.8 irb rdoc ri rubygems man rake libshadow-ruby1.8 curl
cd /tmp
